...
FIELD_GUIDE: list[FieldGuide] = [
    ...
    FieldGuide("待排工單", "工單限定機台", False, "單張工單的特殊限制。空白代表依產品機台產速表判斷；若填 C2,C5，代表這張工單只能排在 C2 或 C5。欄名也可用限定機台、允許機台、可排機台。", "C2,C5"),
    ...
    FieldGuide("機台初始狀態", "機台", False, "進階選填。若要告訴系統排程開始前某台機台最後做的是什麼產品，才需要填。", "C2"),
    FieldGuide("機台初始狀態", "初始產品", False, "進階選填。若空白，系統視為空機台，第一張工單不計換模。", "SIM-C2-A", "一般從新訂單重新排程時可整張表留空；不是用來指定某張工單一定要排在哪台。"),
...
MANUAL_SECTIONS: list[tuple[str, str]] = [
    (
        "Excel 資料準備",
        "Excel 至少要有待排工單與產品機台產速。機台初始狀態是進階選填；空白時系統視為空機台，第一張工單不計換模。換模時間建議填寫，排程會更接近現場。機台可用時間與排程基本設定已改到畫面操作，舊檔仍可相容。",
    ),
    (
        "工單與產品機台",
